...
let handler = async (m, { conn, text, command, usedPrefix }) => {
  ...
  conn.sendMessage(m.chat, {
        text: `🍭¡Lograste cometer tu crimen con exito!, acabas de robar *${amountTaken} Creditos* a @${randomUserId.split("@")[0]}\n\nSe suman *+${amountTaken} Creditos* a ${senderName}.`,
  contextInfo: { 
  ...
  conn.reply(m.chat, `🍭 No fuiste cuidadoso y te atraparon mientras cometias tu cirme, se restaron *-${amountSubtracted} Creditos* a ${senderName}.`, m)
  break
  ...
  conn.sendMessage(m.chat, {
  text: `🍭 Lograste cometer tu crimen con exito, pero te descubrieron y solo lograste tomar *${smallAmountTaken} Creditos* de @${randomUserId.split("@")[0]}\n\nSe suman *+${smallAmountTaken} Creditos* a ${senderName}.`,
  contextInfo: { 
  mentionedJid: [randomUserId],
  }
  }, { quoted: m })
