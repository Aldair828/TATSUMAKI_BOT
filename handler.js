...
global.dfail = (type, m, conn, usedPrefix) => {
    let msg = {
        ...
        unreg: `Hola @${m.sender.split('@')[0]}, BIENVENIDO a TATSUMAKI_BOT.\n\nPrimero para usar el bot tienes que registrarte usando el comando\n\n\`.reg nombre edad\`\n\n[❔] Antes cualquier duda o consulta puedes contactar con *ANIMATRIX*...`,
